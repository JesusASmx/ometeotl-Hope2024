...
train = pd.read_csv("..//Dataset//PolyEN_train.csv")
val = pd.read_csv("..//Dataset//PolyEN_val.csv")
train_df = pd.concat([train, val])

print(train_df["binary"].value_counts())

test_df = pd.read_csv("..//Dataset//Hope_test/PolyEN_test.csv")
    ...
    for i in range(folds):
        try:
            ...
            if folds == 1:
                ...
                entrena = pd.read_csv("..//Dataset//PolyEN_train.csv")
                validac = pd.read_csv("..//Dataset//PolyEN_val.csv")
...
elected = sorted_hs #Tiene la mayor cantidad de samples.
elegido = 1 #Not Hope

#Los 788 con mayor probabilidad de pertenecer a la clase:
elegidos = list(elected)[-519:]
